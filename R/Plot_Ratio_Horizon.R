...
Plot_Annualized_Volatility_Horizon <-function(){
  ...
  #                 xlab= Inicio_data,"/", xlab= Fim_data), font.main=1, line=1.5)
  title(paste("Annualized Volatility of Portfolios over the Investment Horizon:", N_Assets, "Assets"))
  #title(main = paste(
  # xlab= Inicio_data,"/", xlab= Fim_data),
  #line = 0.5,
  #cex = 0.5,
...
Plot_Annualized_Sharpe_Horizon <-function(){
  ...
  #                 xlab= Inicio_data,"/", xlab= Fim_data), font.main=1, line=1.5)
  title(paste("Sharpe Ratio of Portfolio over the Investment Horizon:", N_Assets, "Assets"))
  #title(main = paste(
  # xlab= Inicio_data,"/", xlab= Fim_data),
  #line = 0.5,
  #cex = 0.5,
  ...
  #title(main = paste("Comparativo_Sharpe_Horizon_Anual           ",
  #                 xlab= Inicio_data,"/", xlab= Fim_data), font.main=1, line=1.5)
  title(paste("Sharpe Ratio of Portfolios over the Investment Horizon:", N_Assets, "Assets"))
  #title(main = paste(
  # xlab= Inicio_data,"/", xlab= Fim_data),
  #line = 0.5,
  #cex = 0.5,
...
Plot_Annualized_Alpha_Horizon <-function(){
  ...
  #                 xlab= Inicio_data,"/", xlab= Fim_data), font.main=1, line=1.5)
  title(paste("Jensen's Alpha Ratio of Portfolios over the Investment Horizon:", N_Assets, "Assets"))
  #title(main = paste(
  # xlab= Inicio_data,"/", xlab= Fim_data),
  #line = 0.5,
  #cex = 0.5,
...
Plot_Annualized_Beta_Horizon <-function(){
  ...
  #                 xlab= Inicio_data,"/", xlab= Fim_data), font.main=1, line=1.5)
  title(paste("Beta Ratio of Portfolios over the Investment Horizon:", N_Assets, "Assets"))
  #title(main = paste(
  # xlab= Inicio_data,"/", xlab= Fim_data),
  #line = 0.5,
  #cex = 0.5,
...
Plot_Annualized_Sortino_Horizon <-function(){
  ...
  #                 xlab= Inicio_data,"/", xlab= Fim_data), font.main=1, line=1.5)
  title(paste("Sortino Ratio of Portfolios over the Investment Horizon:", N_Assets, "Assets"))
  #title(main = paste(
  # xlab= Inicio_data,"/", xlab= Fim_data),
  #line = 0.5,
  #cex = 0.5,
...
Plot_Annualized_Var_Horizon <-function(){
  ...
  #                 xlab= Inicio_data,"/", xlab= Fim_data), font.main=1, line=1.5)
  title(paste("Var Ratio of Portfolios over the Investment Horizon:", N_Assets, "Assets"))
  #title(main = paste(
  # xlab= Inicio_data,"/", xlab= Fim_data),
  #line = 0.5,
  #cex = 0.5,
...
Plot_Annualized_CVar_Horizon <-function(){
  ...
  #                 xlab= Inicio_data,"/", xlab= Fim_data), font.main=1, line=1.5)
  title(paste("CVar Ratio of Portfolios over the Investment Horizon:", N_Assets, "Assets"))
  #title(main = paste(
  # xlab= Inicio_data,"/", xlab= Fim_data),
  #line = 0.5,
  #cex = 0.5,
...
Plot_Annualized_RCum_Horizon <-function(){
  ...
  #                 xlab= Inicio_data,"/", xlab= Fim_data), font.main=1, line=1.5)
  title(paste("Cumulative Return Ratio of Portfolios over the Investment Horizon:", N_Assets, "Assets"))
  #title(main = paste(
  # xlab= Inicio_data,"/", xlab= Fim_data),
  #line = 0.5,
  #cex = 0.5,
...
Plot_Annualized_Rm_Horizon <-function(){
  ...
  #                 xlab= Inicio_data,"/", xlab= Fim_data), font.main=1, line=1.5)
  title(paste("Average Return Ratio of Portfolios over the Investment Horizon:", N_Assets, "Assets"))
  #title(main = paste(
  # xlab= Inicio_data,"/", xlab= Fim_data),
  #line = 0.5,
  #cex = 0.5,
