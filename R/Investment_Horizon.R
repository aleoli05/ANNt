...
Investment_Horizon <- function(Tickers, RM, Rf, Initial_Date, Final_Date_Training,
                                Final_Date, Frequency, Periodicity, N_Lags=5, Hidden, Stepmax,
...
t_Test_Diff_Mean_Portfolios(Ratio="Sharpe", Ratio2="Var", Model=1)
t_Test_Diff_Mean_Portfolios(Ratio="Sharpe", Ratio2="Var", Model=2)
t_Test_Diff_Mean_Portfolios(Ratio="Sharpe", Ratio2="Var", Model=1)
t_Test_Diff_Mean_Portfolios(Ratio="Alpha", Ratio2="Beta", Model=1)
t_Test_Diff_Mean_Portfolios(Ratio="Treynor", Ratio2="CVar", Model=1)
t_Test_Diff_Mean_Portfolios(Ratio="Rm", Ratio2="CVar", Model=1)
